...
describe('ProjectService', () => {
  ...
  let authServiceMock: MsalService;
  ...
  beforeEach(() => {
    ...
    authServiceMock = TestBed.inject(MsalService) as jasmine.SpyObj<MsalService>;
  ...
  it('#getProject should return a value', () => {
    sut.getProject(1).subscribe(data => expect(data).toEqual(mockProjects[0]));
  });

  it('#updateProject should return a value', () => {
    sut.updateProject(1, mockProjects[0]).subscribe(data => expect(data).toEqual(mockProjects[0]));
  });

  it('#deleteProject should return a value', () => {
    sut.deleteProject(1).subscribe(data => expect(data).toEqual(mockProjects[0]));
  });
